...
performer_condition = 0.7 #gives top 30%
best_performers = best_performers[best_performers["Score"] >= best_performers["Score"].quantile(performer_condition)]
...
for ticker in best_performers["Ticker"]:
    try:
        ...
        #if we want to understand call this func and print result
