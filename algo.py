...
plt.scatter(data.index, data["Buy Signals"], label="Buy Signal", marker="^", color="#00ff00", linewidth=3)
plt.scatter(data.index, data["Sell Signals"], label="Sell Signal", marker="v", color="#ff0000", linewidth=3)
plt.legend(loc="upper left")
plt.show()